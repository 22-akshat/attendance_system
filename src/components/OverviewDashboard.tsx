...
export const OverviewDashboard: React.FC<OverviewDashboardProps> = ({
  ...
  // Chart data: Net adjustments by employee (top 8 with deductions or OT)
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6 max-w-7xl mx-auto w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-4 sm:p-5 relative overflow-hidden shadow-sm">
          ...
          <div className="mt-3 pt-3 border-t border-slate-800/80 flex items-center justify-between text-[11px] text-slate-400">
            ...
            <span className="font-semibold text-emerald-400">{data.stats.totalPresentCount}</span>
          </div>
        </div>
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-4 sm:p-5 relative overflow-hidden shadow-sm">
          ...
          <div className="mt-2 flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-400 font-medium">monthly rate</span>
          </div>
          <div className="mt-3 pt-3 border-t border-slate-800/80 flex items-center justify-between text-[11px] text-slate-400">
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-4 sm:p-5 relative overflow-hidden shadow-sm">
          ...
          <div className="mt-2 flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-400 font-medium">days org-wide</span>
          </div>
          <div className="mt-3 pt-3 border-t border-slate-800/80 flex items-center justify-between text-[11px] text-slate-400">
            <span>Rules:</span>
            <span className="text-slate-300">Late &gt; 3, Early &gt; 3, Half-days</span>
          </div>
        </div>
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-4 sm:p-5 relative overflow-hidden shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-400">Total OT Days Earned</span>
          ...
          <div className="mt-2 flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-400 font-medium">days credited</span>
          </div>
          <div className="mt-3 pt-3 border-t border-slate-800/80 flex items-center justify-between text-[11px] text-slate-400">
            <span>Total OT Time:</span>
            <span className="font-semibold text-cyan-300">{data.stats.totalOrgOtHours} hours</span>
          </div>
        </div>
      </div>

      {/* Optional Visual Chart Collapsible */}
      {showCharts && (
      ...
      <div className="bg-slate-900/80 border border-slate-800 rounded-2xl overflow-hidden shadow-sm">
        ...
        <div className="p-4 border-b border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-900">
          <div className="flex flex-wrap items-center gap-2">
            <div className="relative">
              ...
              <input
                ...
                className="pl-8 pr-3 py-1.5 rounded-lg bg-slate-950/70 border border-slate-800 text-xs text-slate-200 placeholder:text-slate-500 focus:outline-none focus:border-indigo-500 w-48 sm:w-60"
              />
            </div>
            ...
            <div className="flex items-center gap-1 bg-slate-950/60 p-1 rounded-lg border border-slate-800 text-[11px]">
              ...
              <button
                ...
                className={`px-2.5 py-0.5 rounded-md font-medium transition ${
                  filterType === 'deductions' ? 'bg-red-950 text-red-300' : 'text-slate-400 hover:text-red-400'
                }`}
              >
                Deductions
              </button>
              <button
                ...
                className={`px-2.5 py-0.5 rounded-md font-medium transition ${
                  filterType === 'ot' ? 'bg-blue-950 text-blue-300' : 'text-slate-400 hover:text-blue-400'
                }`}
              >
                OT Earners
              </button>
              {data.stats.totalAnomaliesCount > 0 && (
                <button
                  ...
                  className={`px-2.5 py-0.5 rounded-md font-medium transition ${
                    filterType === 'anomalies' ? 'bg-violet-950 text-violet-300' : 'text-slate-400 hover:text-violet-400'
                  }`}
                >
              ...
              {data.stats.totalEditedCount > 0 && (
                <button
                  ...
                  className={`px-2.5 py-0.5 rounded-md font-medium transition flex items-center gap-1 ${
                    filterType === 'edited' ? 'bg-amber-950 text-amber-300' : 'text-slate-400 hover:text-amber-400'
                  }`}
                >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 border border-slate-700 text-xs font-semibold text-slate-200 hover:text-white transition shrink-0"
          >
            ...
            <thead>
              <tr className="bg-slate-950/60 border-b border-slate-800 text-slate-400 font-semibold select-none">
                <th
                  ...
                  className="py-3 px-3.5 cursor-pointer hover:text-slate-200 text-center w-12"
                >
                  <div className="flex items-center justify-center gap-1">
                    <span>#</span>
                    {sortField === 'sNo' && (sortAsc ? <ArrowUp className="w-3 h-3 text-indigo-400" /> : <ArrowDown className="w-3 h-3 text-indigo-400" />)}
                  </div>
                </th>

                <th
                  onClick={() => handleSort('name')}
                  className="py-3 px-4 cursor-pointer hover:text-slate-200 min-w-[180px]"
                >
                  <div className="flex items-center gap-1">
                    <span>Employee Name</span>
                    {sortField === 'name' && (sortAsc ? <ArrowUp className="w-3 h-3 text-indigo-400" /> : <ArrowDown className="w-3 h-3 text-indigo-400" />)}
                  </div>
                </th>
                ...
                >
                  <div className="flex items-center gap-1">
                    ...
                    {sortField === 'designation' && (sortAsc ? <ArrowUp className="w-3 h-3 text-indigo-400" /> : <ArrowDown className="w-3 h-3 text-indigo-400" />)}
                  </div>
                </th>
                ...
                >
                  <div className="flex items-center gap-1">
                    <span>Shift</span>
                    {sortField === 'shift' && (sortAsc ? <ArrowUp className="w-3 h-3 text-indigo-400" /> : <ArrowDown className="w-3 h-3 text-indigo-400" />)}
                  </div>
                </th>

                <th
                  onClick={() => handleSort('attendanceRatePct')}
                  className="py-3 px-3 cursor-pointer hover:text-slate-200 text-center"
                >
                  <div className="flex items-center justify-center gap-1">
                    <span>Present / Rate</span>
                    {sortField === 'attendanceRatePct' && (sortAsc ? <ArrowUp className="w-3 h-3 text-indigo-400" /> : <ArrowDown className="w-3 h-3 text-indigo-400" />)}
                  </div>
                </th>
                ...
                >
                  <div className="flex items-center justify-center gap-1">
                    <span>Late</span>
                    {sortField === 'lateCount' && (sortAsc ? <ArrowUp className="w-3 h-3 text-indigo-400" /> : <ArrowDown className="w-3 h-3 text-indigo-400" />)}
                  </div>
                </th>
                ...
                >
                  <div className="flex items-center justify-center gap-1">
                    <span>Early</span>
                    {sortField === 'earlyCount' && (sortAsc ? <ArrowUp className="w-3 h-3 text-indigo-400" /> : <ArrowDown className="w-3 h-3 text-indigo-400" />)}
                  </div>
                </th>
                ...
                >
                  <div className="flex items-center justify-center gap-1">
                    <span>Half Day</span>
                    {sortField === 'halfDayCount' && (sortAsc ? <ArrowUp className="w-3 h-3 text-indigo-400" /> : <ArrowDown className="w-3 h-3 text-indigo-400" />)}
                  </div>
                </th>
                ...
                >
                  <div className="flex items-center justify-center gap-1">
                    <span>OT Hours</span>
                    {sortField === 'totalOtMinutes' && (sortAsc ? <ArrowUp className="w-3 h-3 text-indigo-400" /> : <ArrowDown className="w-3 h-3 text-indigo-400" />)}
                  </div>
                </th>
                ...
                >
                  <div className="flex items-center justify-center gap-1">
                    <span>Deduction</span>
                    {sortField === 'totalDeductionDays' && (sortAsc ? <ArrowUp className="w-3 h-3 text-indigo-400" /> : <ArrowDown className="w-3 h-3 text-indigo-400" />)}
                  </div>
                </th>

                <th
                  onClick={() => handleSort('netDaysAdjustment')}
                  className="py-3 px-4 cursor-pointer hover:text-slate-200 text-center"
                  title="Net Adjustment: OT Days Earned - Total Deduction Days"
                >
                  <div className="flex items-center justify-center gap-1">
                    <span>Net Adj</span>
                    {sortField === 'netDaysAdjustment' && (sortAsc ? <ArrowUp className="w-3 h-3 text-indigo-400" /> : <ArrowDown className="w-3 h-3 text-indigo-400" />)}
                  </div>
                </th>
                  ...
                  return (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {emp.summary.editedCount > 0 && (
                            <span
                              ...
                              className="px-1.5 py-0.2 text-[9px] font-bold rounded bg-amber-950 text-amber-300 border border-amber-800 flex items-center gap-0.5"
                            >
                          ...
                          {emp.summary.anomalyCount > 0 && (
                            <span
                              ...
                              className="px-1.5 py-0.2 text-[9px] font-bold rounded bg-violet-950 text-violet-300 border border-violet-800"
                            >
                              Anomaly
                            </span>
                          )}
                      ...
                      <td className="py-3 px-3 text-center">
                        <span
                          className={`font-semibold ${
                            emp.summary.lateCount > 3 ? 'text-red-400 font-bold' : 'text-slate-300'
                          }`}
                        >
                      ...
                      <td className="py-3 px-3 text-center">
                        <span
                          className={`font-semibold ${
                            emp.summary.earlyCount > 3 ? 'text-orange-400 font-bold' : 'text-slate-300'
                          }`}
                        >
                      ...
                      <td className="py-3 px-3 text-center font-mono">
                        <div>{(emp.summary.totalOtMinutes / 60).toFixed(1)}h</div>
                      ...
                      <td className="py-3 px-3 text-center">
                        {emp.summary.totalDeductionDays > 0 ? (
                          <span className="px-2 py-0.5 rounded bg-red-950/70 border border-red-800/60 text-red-400 font-bold font-mono text-[11px]">
                            -{emp.summary.totalDeductionDays.toFixed(1)}d
                          </span>
                        ) : (
                          <span className="text-slate-500 font-mono">0d</span>
                        )}
                      </td>
                      ...
                      <td className="py-3 px-3 text-right">
                        <ChevronRight className="w-4 h-4 text-slate-600 group-hover:text-indigo-400 group-hover:translate-x-0.5 transition inline-block" />
                      </td>
                    </tr>
                  );
                })
